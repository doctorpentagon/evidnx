...
import { ReliabilityAnalysisPanel } from "../components/ReliabilityAnalysisPanel";
...
export function AnalysisPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-5 pb-10">
      ...
      {dataset.data ? <ReliabilityAnalysisPanel key={`reliability-${dataset.data.id}`} dataset={dataset.data} projectId={currentProjectId} /> : null}
